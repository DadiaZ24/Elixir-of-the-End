...
@onready var nenufar_scene = preload("res://Scenes/assets/nenufar.tscn")
@onready var nenufar_tres = preload("res://Scripts/inventory/resources/Ingredients/something_water.tres")
...
func _process(delta):
	...
	if Input.is_action_just_pressed("ui_interact"):
		...
		if inventory_data:
			...
			new_slot_data.item_data = nenufar_tres
